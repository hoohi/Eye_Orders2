...
import com.eyeorders.util.extension.getPixels
import com.tasleem.orders.databinding.ItemOrderHeaderBinding

class StickyHeaderDecoration(private val adapter: OrdersAdapter, root: View) :
    ItemDecoration() {

    private val headerBinding by lazy { ItemOrderHeaderBinding.inflate(LayoutInflater.from(root.context)) }
    ...
    override fun onDrawOver(canvas: Canvas, parent: RecyclerView, state: State) {
        ...
        parent.getChildAdapterPosition(topChild)
            .let { topChildPosition ->
                ...
                headerBinding.timeHeader.text = header
